...
<template>
    <div class="login">
        <div class="box">
            ...
            <input class="password" v-model="data.new_password" type="password" placeholder="新密码">
            <input class="password" v-model="data.confirm_password" type="password" placeholder="确认新密码">
            <input class="email" v-model="data.email" type="email" placeholder="绑定邮箱">
